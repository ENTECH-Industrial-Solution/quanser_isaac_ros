-- Cartographer 2D SLAM for the Quanser QBot Platform in Isaac Sim.
--
-- Frame setup (requires scripts/isaac_fix_odom_tf.py to have been run;
-- the shipped stage publishes world -> base_link and no odom frame at all):
--   Isaac Sim publishes  odom -> base_footprint -> base_link -> sensors
